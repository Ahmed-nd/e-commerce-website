...
<div class="row">
				...
				<tr>
					...
					<div class="modal-dialog" role="document">
						...
						<div class="modal-body">
							are you sure you to delete (<span style="color: red;"><?php echo $key['username']; ?></span>)
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
							<a href="function/delete_admin.php?id=<?php echo $key['id']; ?>" class="btn btn-primary">Delete</a>
						</div>
						</div>
					</div>
					</div>
		...
		<a href="?do=add" class="btn btn-primary btn-lg btn-block">Add new admin</a>
		</div><!--/.row-->