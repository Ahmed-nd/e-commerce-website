...
<div class="row">
				...
				<tr>
					...
					<div class="modal-dialog" role="document">
						...
						<div class="modal-footer">
							...
							<a href="function/delete_category.php?id=<?php echo $key['id']; ?>" class="btn btn-primary">Delete</a>
						</div>
						</div>
					</div>
					</div>
		...
		<a href="?do=add" class="btn btn-primary btn-lg btn-block">Add new category</a>
		</div><!--/.row-->