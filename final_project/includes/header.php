            ...
            <div class="container">
                ...
                <div class="ht-right">
                    ...
                    <div class="top-social">
                        <a href="<?php echo $row_site['facebook']; ?>" target='_blank'><i class="ti-facebook"></i></a>
                        <a href="<?php echo $row_site['twitter']; ?>" target='_blank'><i class="ti-twitter-alt"></i></a>
                        <a href="<?php echo $row_site['instgram']; ?>" target='_blank'><i class="ti-linkedin"></i></a>
                    </div>
                </div>
            </div>
        </div>
